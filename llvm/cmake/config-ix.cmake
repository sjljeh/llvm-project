...
if(LLVM_ENABLE_LIBXML2)
  ...
  if(LibXml2_FOUND)
    if(LLVM_USE_STATIC_LIBXML2)
      ...
      cmake_push_check_state()
      list(APPEND CMAKE_REQUIRED_LIBRARIES LibXml2::LibXml2Static)
      ...
      set(HAVE_LIBXML2 ${HAVE_LIBXML2_STATIC})
    else()
      # Check if libxml2 we found is usable; for example, we may have found a
      # 32-bit library on a 64-bit system which would fail at link time.
      cmake_push_check_state()
