...
enum RelocationTypesRISCV : unsigned {
  ...
  IMAGE_REL_RISCV_ADDR32NB = 0x0002,
  IMAGE_REL_RISCV_ADDR64 = 0x0003,
  IMAGE_REL_RISCV_REL32 = 0x0004,
  IMAGE_REL_RISCV_BRANCH = 0x0005,
  IMAGE_REL_RISCV_JAL = 0x0006,
  IMAGE_REL_RISCV_CALL = 0x0007,
  IMAGE_REL_RISCV_PCREL_HI20 = 0x0008,
  IMAGE_REL_RISCV_PCREL_LO12_I = 0x0009,
  IMAGE_REL_RISCV_PCREL_LO12_S = 0x000A,
  IMAGE_REL_RISCV_HI20 = 0x000B,
  IMAGE_REL_RISCV_LO12_I = 0x000C,
  IMAGE_REL_RISCV_LO12_S = 0x000D,
  IMAGE_REL_RISCV_SECTION = 0x000E,
  IMAGE_REL_RISCV_SECREL = 0x000F,
  IMAGE_REL_RISCV_RVC_JUMP = 0x0010,
  IMAGE_REL_RISCV_RVC_BRANCH = 0x0011,
};
...
enum RelocationTypesAlpha : unsigned {
