...
uint8_t COFFObjectFile::getBytesInAddress() const {
  return COFF::is64Bit(getMachine()) ? 8 : 4;
}
...
StringRef COFFObjectFile::getRelocationTypeName(uint16_t Type) const {
  ...
  case Triple::riscv64:
    switch (Type) {
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_ABSOLUTE);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_ADDR32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_ADDR32NB);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_ADDR64);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_REL32);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_BRANCH);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_JAL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_CALL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_PCREL_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_PCREL_LO12_I);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_PCREL_LO12_S);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_HI20);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_LO12_I);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_LO12_S);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_SECTION);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_SECREL);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_RVC_JUMP);
    LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_RISCV_RVC_BRANCH);
    default:
      return "Unknown";
    }
    break;
  ...
  case Triple::alpha:
    switch (Type) {
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_ABSOLUTE);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFLONG);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFQUAD);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_GPREL32);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_LITERAL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_LITUSE);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_GPDISP);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_BRADDR);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_HINT);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_INLINE_REFLONG);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFHI);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFLO);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_PAIR);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_MATCH);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_SECTION);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_SECREL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFLONGNB);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_SECRELLO);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_SECRELHI);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFQ3);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFQ2);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_REFQ1);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_GPRELLO);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_ALPHA_GPRELHI);
    default:
      return "Unknown";
    }
    break;
  case Triple::mipsel:
    ...
    break;
  case Triple::ppcle:
    Type &= COFF::IMAGE_REL_PPC_TYPEMASK;
    switch (Type) {
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ABSOLUTE);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ADDR64);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ADDR32);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ADDR24);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ADDR16);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ADDR14);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_REL24);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_REL14);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_TOCREL16);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_TOCREL14);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_ADDR32NB);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_SECREL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_SECTION);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_IFGLUE);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_IMGLUE);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_SECREL16);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_REFHI);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_REFLO);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_PAIR);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_SECRELLO);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_SECRELHI);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_GPREL);
      LLVM_COFF_SWITCH_RELOC_TYPE_NAME(IMAGE_REL_PPC_TOKEN);
    default:
      return "Unknown";
    }
    break;
