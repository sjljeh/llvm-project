// RUN: %clang_cc1 -E -dM -ffreestanding -triple=riscv64-pc-windows-msvc < /dev/null | FileCheck -match-full-lines %s

// CHECK: #define _INTEGRAL_MAX_BITS 64
// CHECK-NOT: #define _LP64 1
// CHECK: #define _M_RISCV64 100
...
// CHECK: #define __PTRDIFF_TYPE__ long long int
// CHECK: #define __SIZEOF_LONG_DOUBLE__ 8
// CHECK: #define __SIZEOF_LONG__ 4
// CHECK: #define __SIZEOF_POINTER__ 8
// CHECK: #define __SIZEOF_SIZE_T__ 8
// CHECK: #define __SIZE_TYPE__ long long unsigned int
